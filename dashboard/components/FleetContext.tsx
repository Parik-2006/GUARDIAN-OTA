...
export function createDefaultFleet(): FleetVehicle[] {
  const defaults: { id: string; name: string; model: FleetVehicle["model"]; primary: boolean }[] = [
    { id: "VEH-001", name: "Interceptor Alpha", model: "Interceptor", primary: true },
    { id: "VEH-002", name: "Sentinel Prime",    model: "Sentinel",    primary: false },
    { id: "VEH-003", name: "Voyager One",       model: "Voyager",     primary: false },
  ];
